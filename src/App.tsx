...
const MyPrevButton = () => (
  <PrevButton className='absolute top-1/2 left-0 z-10 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-slate-200 px-4 py-2 shadow'>
...
const MyNextButton = () => (
  <NextButton className='absolute top-1/2 right-0 z-10 flex h-12 w-12 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-slate-200 px-4 py-2 shadow'>
